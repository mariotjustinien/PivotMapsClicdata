var size = 0;
function categories_Ifanadiana_roads4(feature, value) {
...
default:
        ...
        stroke: new ol.style.Stroke({color: 'rgba(130,230,140,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2}),
                    ...
                    break;}};
var styleCache_Ifanadiana_roads4={}
var style_Ifanadiana_roads4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("F_CODE_DES");
    var style = categories_Ifanadiana_roads4(feature, value);
    var labelText = "";
    ...
    if (typeof clusteredFeatures !== "undefined") {
        ...
        if (!styleCache_Ifanadiana_roads4[key]){
            ...
            styleCache_Ifanadiana_roads4[key] = new ol.style.Style({"text": text})
        }
    } else {
        if ("" !== null) {
            labelText = String("");
    ...
    var allStyles = [styleCache_Ifanadiana_roads4[key]];
