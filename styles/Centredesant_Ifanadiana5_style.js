var size = 0;
var ranges_Centredesant_Ifanadiana5 = [[0.000000, 15.000000, [ new ol.style.Style({
...
var styleCache_Centredesant_Ifanadiana5={}
var style_Centredesant_Ifanadiana5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Nb_referen");
    var style = ranges_Centredesant_Ifanadiana5[0][2];
    for (i = 0; i < ranges_Centredesant_Ifanadiana5.length; i++){
        var range = ranges_Centredesant_Ifanadiana5[i];
    ...
    if (typeof clusteredFeatures !== "undefined") {
        ...
        if (!styleCache_Centredesant_Ifanadiana5[key]){
            ...
            styleCache_Centredesant_Ifanadiana5[key] = new ol.style.Style({"text": text})
        }
    } else {
    ...
    var allStyles = [styleCache_Centredesant_Ifanadiana5[key]];
